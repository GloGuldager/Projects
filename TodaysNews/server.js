...
// A GET route for scraping MIT Technology
app.get("/scrape", function(req, res) {
  ...
  var titleArr = [];
    ...
    request("https://www.technologyreview.com/artificial-intelligence/", function(error, response, html) {
    ...
    $(".grid-tz__title").each(function(i, element) {
